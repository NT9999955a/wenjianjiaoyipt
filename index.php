...
if (!file_exists(TOKEN_FILE)) file_put_contents(TOKEN_FILE, '[]'); // 初始化令牌文件
                ...
                <?php else: ?>
                    <div class="user-info">
                        ...
                        <a href="#" onclick="showSection('register')" class="btn btn-primary">
                            <svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10585"><path d="M320 307.2c6.4-95.2 84.8-172.8 180-178.4 111.2-6.4 204 81.6 204 192 0 105.6-85.6 192-192 192-110.4 0-199.2-93.6-192-205.6zM575.2 768c0-72.8 40.8-136.8 100.8-168.8C616 584 556 576 511.2 576 384 576 128 640 128 768v96c0 17.6 14.4 32 32 32h464c-30.4-33.6-48.8-78.4-48.8-128z m320.8-32h-96V640h-64v96H640v64h96v96h64v-96h96v-64z" p-id="10586"></path></svg>
                            <!--<svg viewBox="0 0 24 24">
            ...
            <div class="panel">
                ...
                <div class="menu">
                    ...
                    <div class="menu-item" onclick="showSection('upload')">
                        <svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2933"><path d="M160 224 240 128 784 128 864 224 160 224ZM640 672 640 800 384 800 384 672 192 672 490.016 361.408C502.144 348.736 521.92 348.768 533.984 361.344L832 672 640 672ZM942.208 229.312 849.792 90.688C840 76 817.792 64 800.256 64L223.744 64C206.56 64 184.032 75.968 174.208 90.688L81.792 229.312C72 244 64 270.368 64 288.064L64 896.288C64 931.52 92.544 960 127.712 960L896.288 960C931.2 960 960 931.488 960 896.288L960 288.064C960 270.048 952.032 244.032 942.208 229.312" p-id="2934"></path></svg>
                        上传文件
                    </div>
                    ...
                    <div class="file-list" id="file-list">
                                ...
                                <div class="file-body">
                                    ...
                                    <div class="file-meta">
                                        ...
                                        <div>
                                            ...
                                            上传时间: <?php echo date('m-d H:i', strtotime($file['upload_time'])); ?>
                                        </div>
                                    </div>
                                    <div class="file-meta">
                                        <div>
                        ...
                        <?php else: ?>
                            <div class="empty-state">
                                <svg viewBox="0 0 24 24">
                                    <path d="M14,2H6C4.89,2 4,2.89 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/>
                                </svg>
                                <h3>暂无文件</h3>
                                <p>当前没有任何文件可供交易</p>
                            </div>
                    ...
                    <?php if ($user): ?>
                        ...
                        <form method="post">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3747"><path d="M392.533333 806.4L85.333333 503.466667l59.733334-59.733334 247.466666 247.466667L866.133333 213.333333l59.733334 59.733334L392.533333 806.4z" fill="#F8F8FF" p-id="3748"></path></svg>
                                <!--
                                <svg viewBox="0 0 24 24">
                                ...
                                <div class="file-body">
                                    ...
                                    <div class="file-actions">
                                        <div class="action-btn" style="background: #f0f5ff; color: #1d39c4; border: 1px solid #adc6ff;">
                                            <svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="
.890765937777775 0-36.247071857777776s25.890765937777775-10.35630592 36.247071857777776 0l103.56306147555556 103.56306147555556 103.56306147555556-103.56306147555556c10.35630592-10.35630592 25.890765937777775-10.35630592 36.247071857777776 0s10.35630592 25.890765937777775 0 36.247071857777776l-85.43952554666666 85.43952554666666h77.67229553777777c15.534458879999999 0 25.890765937777775 10.35630592 25.890765937777775 25.890765937777775s-10.35630592 25.890765937777775-25.890765937777775 25.8907648h-106.15213738666667v62.137837795555555h103.56306147555556z" fill="" p-id="5475"></path></svg>
                                            <!--<svg viewBox="0 0 24 24">
                                                <path d="M12,15.5A3.5,3.5 0 0,1 15.5,12A3.5,3.5 0 0,1 12,8.5A3.5,3.5 0 0,1 8.5,12A3.5,3.5 0 0,1 12,15.5M19.43,12.97C19.47,12.65 19.5,12.33 19.5,12C19.5,11.67 19.47,11.34 19.43,11L21.54,9.37C21.73,9.22 21.78,8.95 21.66,8.73L19.66,5.27C19.54,5.05 19.27,4.96 19.05,5.05L16.56,6.05C16.04,5.66 15.5,5.32 14.87,5.07L14.5,2.42C14.46,2.18 14.25,2 14,2H10C9.75,2 9.54,2.18 9.5,2.42L9.13,5.07C8.5,5.32 7.96,5.66 7.44,6.05L4.95,5.05C4.73,4.96 4.46,5.05 4.34,5.27L2.34,8.73C2.21,8.95 2.27,9.22 2.46,9.37L4.57,11C4.53,11.34 4.5,11.67 4.5,12C4.5,12.33 4.53,12.65 4.57,12.97L2.46,14.63C2.27,14.78 2.21,15.05 2.34,15.27L4.34,18.73C4.46,18.95 4.73,19.03 4.95,18.95L7.44,17.94C7.96,18.34 8.5,18.68 9.13,18.93L9.5,21.58C9.54,21.82 9.75,22 10,22H14C14.25,22 14.46,21.82 14.5,21.58L14.87,18.93C15.5,18.67 16.04,18.34 16.56,17.94L19.05,18.95C19.27,19.03 19.54,18.95 19.66,18.73L21.66,15.27C21.78,15.05 21.73,14.78 21.54,14.63L19.43,12.97Z"/>
                                            </svg>-->
            ...
            <div class="panel">
                <div id="login-section" class="section active">
                    ...
                    <form method="post">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9846"><path d="M512 0a512 512 0 1 0 512 512A512 512 0 0 0 512 0z m251.112727 512a28.16 28.16 0 0 1-8.610909 20.48l-152.669091 152.901818a30.021818 30.021818 0 0 1-20.712727 8.610909 29.323636 29.323636 0 0 1-20.48-49.803636l103.098182-103.098182H286.254545a29.090909 29.090909 0 1 1 0-58.181818h377.483637l-103.098182-103.098182a29.090909 29.090909 0 0 1 41.192727-41.192727l152.669091 152.901818a23.272727 23.272727 0 0 1 4.189091 6.283636 13.963636 13.963636 0 0 1 2.094546 3.025455 30.952727 30.952727 0 0 1 2.327272 11.170909z" p-id="9847"></path></svg>
                            登录
                        </button>
